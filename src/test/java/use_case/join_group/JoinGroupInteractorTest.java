...
//
//        // creating test group
//        CreateGroupOutputBoundary testGroupPresenter = new CreateGroupPresenter();
...
//        JoinGroupOutputBoundary testPresenter = new JoinGroupOutputBoundary(); // <-- replace with real presenter
...
//    }
    public void joinGroupTestWithUI() {
        // create dao
        InMemoryGroupDataAccessObject userRepository = dao;
