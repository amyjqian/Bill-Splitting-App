...
public class SettleUpDataAccessObject implements SettleUpDataAccessInterface {
    ...
    public SettleUpDataAccessObject(String apiKey) {
        this.apiKey = apiKey;
    }
    ...
    public List<Expense> getGroupExpenses(String groupId) throws Exception {
        ...
        try {
            ...
            if (!root.has("expenses")) {
                throw new RuntimeException("Unexpected API response: missing 'expenses' field\n" + responseString);
            }

            JSONArray expenseArray = root.getJSONArray("expenses");
    ...
    private Expense parseExpense(JSONObject json) {
        try {
            ...
            String category = json.optString("category", "unknown");
            ...
            Expense exp = new Expense(id, description, amount, category, participants, paidBy);
            return exp;
